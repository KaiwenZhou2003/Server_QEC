...
#         ler, ler_per_round = measure_noise_simulation(css_code,p,[bposddecoder,bpdecoder,gaussdecoder,reshapeddecoder],num_trials=100000,num_repeat=18)
#     if p in [0.001, 0.002, 0.003, 0.004, 0.005]:
#         ler, ler_per_round = measure_noise_simulation(css_code,p,[bposddecoder,bpdecoder,gaussdecoder,reshapeddecoder],num_trials=10000,num_repeat=18)
